usingProviderMethodLogService();
function usingProviderMethodLogService()
{
    ...
    angular.module("customServices", [])
        .provider("usingProviderMethodLogService", function () {
            var counter = true;
            var debug = true;
            return {
                ...
                // аргументами метода provider являются название сервиса и фабричная функция,
                // которая должна возвращать объект provider
                ...
                // преимуществом использования provider метода является то что вы можете
                // добавить некую функцию в provider метод
