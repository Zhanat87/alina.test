usingFactoryMethodLogService();
function usingFactoryMethodLogService()
{
    ...
    angular.module("customServices", [])
        ...
        // что объект создается только один раз(singleton) и
        // все пользователи этого сервиса работают с одним и тем же объектом
        .factory("usingFactoryMethodLogService", function () {
            var messageCount = 0;
            return {
                log: function (msg) {
