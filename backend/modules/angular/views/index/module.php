...
<div class="row">
    ...
    <pre>
        Поведение содержимого в рамках этого элемента будет управляться
        с помощью класса listCtrl, определенного в module.js.

        Конструкция {{ }} указывает на место связывания данных в HTML.
        AngularJS автоматически обновит это место, если функция remain()
        вернет значение, отличное от предыдущего
        ...
        Связывает форму с моделью. Это значит,
        что любые изменения в форме обновят данные модели,
